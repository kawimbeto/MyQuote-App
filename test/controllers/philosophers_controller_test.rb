...
class PhilosophersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create philosopher" do
    assert_difference("Philosopher.count") do
      post philosophers_url, params: { philosopher: { bio: @philosopher.bio, birth_year: @philosopher.birth_year, death_year: @philosopher.death_year, first_name: @philosopher.first_name, last_name: @philosopher.last_name } }
    end
  ...
  test "should update philosopher" do
    patch philosopher_url(@philosopher), params: { philosopher: { bio: @philosopher.bio, birth_year: @philosopher.birth_year, death_year: @philosopher.death_year, first_name: @philosopher.first_name, last_name: @philosopher.last_name } }
